...
- URL navigation using `react-router`
- Global styles (`global.css`)
- Setup for `react-bootstrap`, `bootswatch`, and `react-bootstrap-icons`

## 2. AI / LLM Usage
* **What I asked the AI:** How do you calculate a FICO score with NodeJS?
* **How it helped & What I learned:** I learned the different factors that make up a credit score and how much each one affects the overall score. I used this knowledge to write the `useFicoScoreDetails` hook.

All other code was handwritten.
