        ...
        <Navbar bg="light" expand="lg" className="d-lg-none" sticky="top">
            <Container fluid>
...

                {
                    ...
                    <Nav.Link href="/account" style={{ marginRight: "2vw" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="2vh" height="2vh" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
